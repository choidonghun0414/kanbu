            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="/kanbu/resources/img/destination/jeju_hub1.jpg" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="/kanbu/resources/img/destination/hwangwoozi_2.png" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="/kanbu/resources/img/destination/camelliahill_4.png" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="/kanbu/resources/img/destination/cheonjiyeonFalls_2.png" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="/kanbu/resources/img/destination/saehwaMarket_2.png" alt="">
                        </div>
                        <div class="content">
