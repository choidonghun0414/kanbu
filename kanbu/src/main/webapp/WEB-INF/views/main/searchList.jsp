                        ...
                        <nav class="blog-pagination justify-content-center d-flex">
                        	<ul class="pagination">
                        		<c:if test="${startPage > 5}">
                               		<li class="page-item">
                               			<a href="/kanbu/search.com?pageNum=${startPage-5}" class="page-link" aria-label="Previous">
                               	...
                               	<c:forEach var="i" begin="${startPage}" end="${endPage}">
                               		<li class="page-item">
                               			<a href="/kanbu/search.com?pageNum=${i}" class="page-link">${i}</a>
                               		</li>
                             	</c:forEach>
                             	
                             	<c:if test="${endPage < pageCount}">
                               		<li class="page-item">
                               			<a href="/kanbu/search.com?pageNum=${startPage+5}" class="page-link" aria-label="Next">
